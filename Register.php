        ...
        if (mysqli_error($con)) {
            ...
            if (mysqli_num_rows($res) != 0) {
                ...
                if (mysqli_error($con)) {
                    ...
                    $insert = "insert into users(id, name, dob, phone, city) values('" . $id . "', '" . $name . "', '" . $dob . "',  '" . $pn . "',  '" . $city . "')";
                    $res = mysqli_query($con, $insert);
                    if (mysqli_error($con)) {
                        echo "<script>alert('Something went wrong')</script>";
                    } else {
...
<body style="background:url('backg.jpg'); background-position:center; background-size: cover;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link text-white active" aria-current="page" href="./Register.php">Register</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container d-flex flex-column  align-items-center" style="width: 50%;
                                                                            margin: 20px;
                                                                            border-radius: 8px;
                                                                            padding: 35px;
                                                                            background-color: #7a483ad9;
                                                                            color:white;">

    
    <h1 class='m-2'>Register Yourself</h1>
        <form class='w-75 d-flex flex-column justify-content-center' method="POST">
            <div class="mb-1">
            ...
            <button type="submit" name='submit' class="my-2 btn btn-primary">Register</button>
        </form>
</div>
    </div>
